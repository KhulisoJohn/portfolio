            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Build web applications using C# and the .NET framework. I understand the basics
                    of object-oriented programming (OOP), can work with controllers, models, and
                    views (MVC), and write clean code that follows standard best practices.
                  </p>
                </div>
              </div>
            </div>
